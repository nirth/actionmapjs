// @flow
import type {Event, EventType, Guard, Payload} from './types'

export const allowEventType = (allowedEventType: Guard) => ({type, payload}: Event): boolean => type === allowedEventType
